...
By setting user attributes, you can display information about the user on the paywall. You can also define [rules](/docs/campaign-rules) in a campaign to determine which paywall to show to a user, based on their user attributes.
