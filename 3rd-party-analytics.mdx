...
SuperwallKit automatically tracks some internal events. You can [view the list of events here](/docs/tracking-analytics). We encourage you to also track them in your own analytics by implementing `didTrackSuperwallEventInfo(_:)` in your `SuperwallDelegate`:
...
**Note**: You might also want to set user attribute to allow for [Cohorting in 3rd Party Tools](/docs/cohorting-in-3rd-party-tools)
